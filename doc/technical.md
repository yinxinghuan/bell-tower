...
- 游戏：The Bell Tower
- 类型：social
- 简述：A dim cathedral bell tower, one rope-pull a day. Drag, release: BONG, a 6-second decay, then it rests till tomorrow. Others' rings echo as distant bongs; hit 100 in a day and all hear one chime.
...
- 平台元信息：meta.title=The Bell Tower；cover_url=/poster.png；category=social；uuid=7484763a-965f-46db-9b36-d0c1e352785a
...
- `src/BellTower/BellTower.less`
- `src/BellTower/BellTower.tsx`
- `src/BellTower/types.ts`
- `src/BellTower/index.ts`
- `src/BellTower/utils/audio.ts`
- `src/BellTower/components/BellScene.tsx`
- `src/BellTower/components/Ticker.tsx`
- `src/BellTower/components/Wall.tsx`
